...
export const STRINGS = {
  en: {
    ...
    /* --- what we rebuilt --- */
    rebuiltOf: 'The EPFO member portal, rebuilt',
    compareLink: 'See what we changed',
    compareHead: 'What we changed',
    compareSub: 'The same job — withdrawing your own PF — on the current EPFO member portal, and here. Every row is a step you actually have to get through.',
    compareToday: 'On the portal today',
    compareOurs: 'Here',
    compareSteps: [
      ['Finding the right page',
       'Several portals under one site. You have to know that withdrawal lives under Services, For Employees, Member UAN/Online Service.',
       'One entry point. Sign in and the next step is chosen for you.'],
      ['Signing in',
       'UAN and a password you set years ago, plus a captcha. Forgot it and you are in a reset flow.',
       'UAN and an Aadhaar OTP. Nothing to remember.'],
      ['Knowing if you are ready',
       'Nothing checks you. KYC status sits under Manage, KYC, in wording like "Approved by Establishment" that does not say whether you can file.',
       'A readiness scan runs before anything else and answers the real question: would this claim be rejected today?'],
      ['Knowing what is wrong',
       'You find out after filing, in a one-line remark such as "Name not matching as per records".',
       'You find out before filing, with the exact mismatch shown — which name, on which record.'],
      ['Knowing who fixes it',
       'Not stated. Members re-file the same claim when the blocker was their ex-employer all along.',
       'Every finding says whether you, your employer, or EPFO must act, and the list is grouped that way.'],
      ['Doing something about it',
       'You are told to contact your employer.',
       'The letter is written for you, naming the exact months or dates, in English or Hindi.'],
      ['Choosing the claim',
       'A dropdown of form numbers. You are expected to know that 19 is final settlement and 10C is pension.',
       'Plain descriptions, what you are eligible for today, and why the others are locked.'],
      ['Knowing what you get',
       'The amount is not shown before you commit, and TDS appears only in the credited figure.',
       'Net amount after tax before you file, plus the tax you could avoid by seeding a PAN first.'],
      ['Knowing how long',
       'No estimate.',
       'Auto-settlement in about 3 days, or the 20-day Citizen\'s Charter — and which conditions you meet.'],
      ['Waiting',
       'A status code with little explanation, and no sense of whether the wait is normal.',
       'Each stage explained in plain words, against a running 20-day clock.'],
      ['Being kept waiting',
       'Nothing happens at day 21. The wait just continues.',
       'The breach is flagged and the grievance is drafted for you.'],
      ['Being rejected',
       'A one-line remark and no path forward. Many members re-file the identical claim.',
       'The remark is decoded into causes and fixes, and you are told plainly that you re-file rather than appeal.']
    ],
    compareOutcomeHead: 'The difference this makes',
    compareOutcome: 'Roughly 1.74 crore of 7.96 crore claims were rejected in 2024-25 — about 22%. Nearly all of it for things the portal could have caught before the member pressed submit. That is the change: not a new colour scheme, but moving the check to before the claim instead of after it.',
    compareHonest: 'The left column describes the current journey as documented by EPFO and as members report it. No screenshots, logos or code from the EPFO site are used anywhere in this prototype.',
  ...
  hi: {
    ...
    rebuiltOf: 'EPFO सदस्य पोर्टल, नए सिरे से',
    compareLink: 'हमने क्या बदला, देखें',
    compareHead: 'हमने क्या बदला',
    compareSub: 'वही काम — अपना PF निकालना — आज के EPFO सदस्य पोर्टल पर, और यहाँ। हर पंक्ति एक ऐसा क़दम है जिससे आपको सचमुच गुज़रना पड़ता है।',
    compareToday: 'आज पोर्टल पर',
    compareOurs: 'यहाँ',
    compareSteps: [
      ['सही पेज ढूँढ़ना',
       'एक ही साइट पर कई पोर्टल। आपको पता होना चाहिए कि निकासी Services, For Employees, Member UAN/Online Service के नीचे है।',
       'एक ही प्रवेश बिंदु। लॉगिन कीजिए, अगला क़दम अपने आप चुन लिया जाता है।'],
      ['लॉगिन करना',
       'UAN और सालों पहले बनाया पासवर्ड, साथ में कैप्चा। भूल गए तो रीसेट की प्रक्रिया।',
       'UAN और आधार OTP। याद रखने को कुछ नहीं।'],
      ['यह जानना कि आप तैयार हैं या नहीं',
       'कोई जाँच नहीं होती। KYC स्थिति Manage, KYC के नीचे "Approved by Establishment" जैसे शब्दों में पड़ी रहती है, जिससे यह पता ही नहीं चलता कि दावा भरा जा सकता है या नहीं।',
       'सबसे पहले तैयारी जाँच चलती है और असली सवाल का जवाब देती है: क्या आज भरा गया दावा रद्द हो जाएगा?'],
      ['यह जानना कि ग़लत क्या है',
       'भरने के बाद पता चलता है, एक पंक्ति की टिप्पणी में — जैसे "Name not matching as per records"।',
       'भरने से पहले पता चलता है, और ठीक-ठीक दिखता है कि कौन-सा नाम किस रिकॉर्ड पर अलग है।'],
      ['यह जानना कि ठीक कौन करेगा',
       'कहीं नहीं लिखा। लोग वही दावा दोबारा भरते रहते हैं, जबकि रुकावट उनके पुराने नियोक्ता के पास थी।',
       'हर बिंदु बताता है कि आप, आपका नियोक्ता या EPFO — किसे करना है, और सूची उसी हिसाब से बँटी है।'],
      ['उस पर कुछ करना',
       'कह दिया जाता है कि नियोक्ता से संपर्क करें।',
       'पत्र आपके लिए लिख दिया जाता है, ठीक वही महीने या तारीख़ें लिखकर, हिंदी या अंग्रेज़ी में।'],
      ['दावा चुनना',
       'फ़ॉर्म नंबरों की सूची। मान लिया जाता है कि आप जानते हैं कि 19 अंतिम निपटान है और 10C पेंशन।',
       'सीधी भाषा में विवरण, आज आप किसके पात्र हैं, और बाक़ी क्यों बंद हैं।'],
      ['यह जानना कि कितना मिलेगा',
       'भरने से पहले रकम नहीं दिखती, और TDS सिर्फ़ जमा हुई राशि में दिखता है।',
       'भरने से पहले टैक्स के बाद की रकम, और वह टैक्स भी जो PAN जोड़कर बचाया जा सकता है।'],
      ['यह जानना कि कितना समय लगेगा',
       'कोई अनुमान नहीं।',
       'लगभग 3 दिन में स्वतः निपटान, या 20 दिन का नागरिक चार्टर — और आप कौन-सी शर्तें पूरी करते हैं।'],
      ['इंतज़ार करना',
       'एक स्थिति कोड, बहुत कम व्याख्या, और यह पता नहीं कि इंतज़ार सामान्य है या नहीं।',
       'हर चरण सीधी भाषा में समझाया गया, और साथ में 20 दिन की चलती घड़ी।'],
      ['इंतज़ार कराया जाना',
       '21वें दिन कुछ नहीं होता। इंतज़ार बस चलता रहता है।',
       'देर होते ही चिह्नित होता है और शिकायत आपके लिए लिख दी जाती है।'],
      ['रद्द होना',
       'एक पंक्ति की टिप्पणी और आगे का कोई रास्ता नहीं। बहुत लोग वही दावा दोबारा भर देते हैं।',
       'टिप्पणी का मतलब कारणों और उपायों में खोला जाता है, और साफ़ बताया जाता है कि अपील नहीं, दोबारा भरना होता है।']
    ],
    compareOutcomeHead: 'इससे क्या फ़र्क़ पड़ता है',
    compareOutcome: '2024-25 में 7.96 करोड़ में से लगभग 1.74 करोड़ दावे रद्द हुए — क़रीब 22%। इनमें से लगभग सब कुछ ऐसा था जिसे पोर्टल सबमिट दबाने से पहले ही पकड़ सकता था। यही बदलाव है: नया रंग-रूप नहीं, बल्कि जाँच को दावे के बाद से हटाकर उससे पहले ले आना।',
    compareHonest: 'बायाँ स्तंभ आज की प्रक्रिया बताता है, जैसा EPFO के दस्तावेज़ों में है और जैसा सदस्य बताते हैं। इस प्रोटोटाइप में EPFO साइट का कोई स्क्रीनशॉट, लोगो या कोड इस्तेमाल नहीं हुआ है।',
